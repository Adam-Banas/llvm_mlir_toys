...
public:
  ...
  matchAndRewrite(Operation *op, ArrayRef<Value> operands,
    ...
    mlir::SmallVector<Value, 4> loopIvs;
...
private:
  ...
  /// module if necessary.
  static mlir::FlatSymbolRefAttr getOrInsertPrintf(PatternRewriter &rewriter,
                                             ModuleOp module) {
  ...
  static Value getOrCreateGlobalString(mlir::Location loc, OpBuilder &builder,
...
struct ToyToLLVMLoweringPass
    : public mlir::PassWrapper<ToyToLLVMLoweringPass, mlir::OperationPass<ModuleOp>> {
  MLIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(ToyToLLVMLoweringPass)

  void getDependentDialects(mlir::DialectRegistry &registry) const override {
    registry.insert<LLVM::LLVMDialect, mlir::scf::SCFDialect>();
  }
